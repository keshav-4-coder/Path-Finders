...
import "./Footer.css"; // optional CSS file if you want custom styles
  ...
  return (
    <footer className="footer">
      <div className="footer-grid">
        <div>
          <h3 className="footer-title">Student Guide</h3>
          <p className="footer-text">
            Empowering students and professionals to discover their perfect
            career path with AI-powered guidance and personalized learning.
          </p>
        </div>
