...
const Profile = () => {
  const [profile, setProfile] = useState({
    name: "Hajur ko subha nam",
    email: "hajurkoemail@example.com",
    occupation: "hajurko profession",
    interests: "hajurko intrests haru",
    location: "Nepal ta hola ni",
    bio: "kei choto hosh",
    profilePicture: "./Logo.png",
    education: "Bachelor's in Computer Science, TU, 2020",
    skills: "React, JavaScript, Python, AI",
    experience: "Software Engineer at Tech Co (2021-2023); Freelance Developer (2020-2021)",
